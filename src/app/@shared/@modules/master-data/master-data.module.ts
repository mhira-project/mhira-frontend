...
import { NzIconModule, NzInputModule, NzTableModule, NzTagModule } from 'ng-zorro-antd';
...
@NgModule({
  ...
  imports: [CommonModule, SharedModule, NgxInputSearchModule, NzInputModule, NzIconModule, NzTableModule, NzTagModule],
