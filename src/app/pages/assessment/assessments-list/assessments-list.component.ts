...
export class AssessmentsListComponent {
  ...
  private async deleteAssessment(assessment: FormattedAssessment, statusCancel: boolean): Promise<void> {
    ...
    this.loading = true;
    this.assessmentService
      .deleteAssessment(assessment, statusCancel)
      .pipe(finalize(() => (this.loading = false)))
      .subscribe(
        (archived) => {
          if (!archived) {
  ...
  private async sendAssessmentEmail(assessment: FormattedAssessment) {
    ...
    this.loading = true;
    this.assessmentService
      .sendAssessmentEmail(assessment)
      .pipe(finalize(() => (this.loading = false)))
      .subscribe(
        (archived) => {
          if (!archived) {
