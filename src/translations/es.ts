export default {
  ...
  assessmentForm: {
    ...
    completeAssessmentMessage: 'Puedes enviar la evaluación ahora',
    overview: 'Resumen',
    next: 'Siguiente',
    prev: 'Anterior',
    ...
    submit: 'Entregar',
    cancel: 'Cancelar',
    consentModalTitle: 'Necesitamos su consentimiento para proceder con la evaluación.',
    acceptConsentButton: 'Acepto',
  },
  questionnaires: {
  ...
  createAssessment: {
    ...
    consentCheckbox1: 'Casilla de verificación Primer consentimiento',
    consentCheckbox2: 'Casilla de verificación de segundo consentimiento',
    consentDescription: 'Mensaje de consentimiento',
    submitContent: 'Enviar mensaje',
    consent: 'Consent',
