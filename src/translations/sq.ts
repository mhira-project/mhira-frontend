export default {
  ...
  assessmentForm: {
    ...
    submit: 'Ruaj',
    cancel: 'Anulo',
    consentModalTitle: 'Duhet te jeni dakord me kushtet e perdorimit',
    acceptConsentButton: 'Une pranoj',
  },
  questionnaires: {
  ...
  createAssessment: {
    ...
    other: 'Të tjera',
    consentCheckbox1: 'Kushtet e perdorimit 1',
    consentCheckbox2: 'Kushtet e perdorimit 2',
    consentDescription: 'Pershkrimi i kushteve te perdorimit',
    submitContent: 'Mesazhi i dorezimit',
    consent: 'Kushte e perdorimit',
    consentGiven: 'Kushtet e perdorimit jane pranuar',
  },
  form: {
    system: {
